...
import com.edifixio.simplElastic.application.SimpleRequestConfig;
...
public class SimpleRequestConfigTest {
	...
	public static Collection<?> parameters() {
		...
		JsonElementConfig classJsc=new SimpleJsonStringConfig("com.edifixio.simplElastic.object.TestObject");
